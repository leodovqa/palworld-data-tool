...
const passiveAbilities = {
  ...
  Legend: {
    name: "Legend",
    type: "combat",
    description: "Ultimate combat ability",
  },
  "Demon God": {
    name: "Demon God",
    type: "combat",
  ...
  Serenity: {
    name: "Serenity",
    type: "combat",
    description: "Reduces cooldowns, hidden multiplier",
  },
  Musclehead: {
    name: "Musclehead",
    type: "combat",
    description: "Physical attack boost",
  },
  Ferocious: {
    name: "Ferocious",
    type: "combat",
    description: "Aggressive attack enhancement",
  },
  Invader: {
    name: "Invader",
    type: "combat",
    description: "Invasion-based attack",
  },
  ...
  "Eternal Engine": {
    name: "Eternal Engine",
    type: "movement",
    description: "Stamina management (2026 update)",
  },
  Nimble: {
    name: "Nimble",
    type: "movement",
    description: "Ground speed optimization",
  },
  "King of the Waves": {
    name: "King of the Waves",
    type: "movement",
    description: "Water movement mastery",
  },
  "Ace Swimmer": {
    name: "Ace Swimmer",
    type: "movement",
    description: "Swimming optimization",
  },
  Vanguard: {
    name: "Vanguard",
    type: "movement",
    description: "Front-line leadership",
  },
};
...
module.exports = {
  ...
  getPassiveSets: function (palNumber, element, palType) {
    const combat = getCombatPassives(
      parseInt(String(palNumber).replace(/[^0-9]/g, ""), 10),
      element,
      true,
    );
    let mount = null;
